...
export const home = [
  {
    text: "",
    name: "HIMS",
    post: "Health Information Managment System",
    design:"",
...
export const services = [
  ...
  },
  {
    id: 2,
    icon: <CropRotate />,
    title: "Patient 2 Report",
    desc: "Lorem Ipsum simply text of the printing and type setting industry when an unknown printing simply",
  },
  {
    id: 3,
    icon: <ViewInAr />,
    title: "Patient 3 Report",
    desc: "Lorem Ipsum simply text of the printing and type setting industry when an unknown printing simply",
  },
  {
    id: 4,
    icon: <PieChart />,
    title: "Patient 4 Report",
    desc: "Lorem Ipsum simply text of the printing and type setting industry when an unknown printing simply",
  },
  {
    id: 5,
    icon: <Code />,
    title: "Patient 5 Report",
    desc: "Lorem Ipsum simply text of the printing and type setting industry when an unknown printing simply",
  },
  {
    id: 6,
    icon: <BarChart />,
    title: "Patient 7 Report",
    desc: "Lorem Ipsum simply text of the printing and type setting industry when an unknown printing simply",
  },
]
export const project = [
  {
    ...
    icon: <CloudOutlined />,
    num: "89",
    title: "Who got money help above 10,000",
  },
  {
    id: 2,
    icon: <FavoriteBorder />,
    num: "231",
    title: "Familys are taken care",
  },
  {
    id: 3,
    icon: <Public />,
